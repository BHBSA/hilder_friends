...
class get_building_info(object):
    ...
    def start_building_info(self, ch, method, properties, body):
        ...
        self.channel.queue_declare(queue='fgg_building_id')
        headers = {
        ...
        print(ResidentialAreaID, city_name)
        ...
        try:
            ...
            if 'true' or 'True' in response.text:
                building_list = json.loads(response.text)['list']
                if not building_list:
                    ...
                    self.coll_insert.insert_one(info)
    ...
    def consume_queue(self, cookie):
        ...
        self.channel.basic_consume(consumer_callback=self.start_building_info, queue='fgg_community_id',
                                   consumer_tag=cookie)
